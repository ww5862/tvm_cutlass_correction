...
"""
    ...
    def emit(self, operation, no_beta_scaling=False, split_k=1, batched=False):
        ...
        values["split_k_serial"] = "true," if split_k > 1 else "false,"
...
"""
    ...
    if batched:
        ...
        aux_map["batch"] = attrs["batch"]
        aux_map["split_k_slices"] = ", {}".format(attrs["split_k"]) if int(attrs["split_k"]) > 1 else ""
    else:
